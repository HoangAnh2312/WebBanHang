...
namespace Ecommerces_asp.net.Areas.Admin.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,ProductId,UnitPrice,Quantity,Discount")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderId,ProductId,UnitPrice,Quantity,Discount")] OrderDetail orderDetail)
        {
