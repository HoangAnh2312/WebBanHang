...
namespace Ecommerces_asp.net.Areas.Admin.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        {
            var marketContext = _context.Orders.Include(o => o.Customer);
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,OrderDate,RequireDate,Receiver,Address,Description,Amount")] Order order)
        {
